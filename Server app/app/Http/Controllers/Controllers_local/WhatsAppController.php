    ...
    public function sendWhatsApp(Request $request)
    {
        try {
            ...
            $validatedData = $request->validate([
                ...
                'to.required' => 'El campo "to" (número de teléfono) es requerido',
                'message.required' => 'El campo "message" (mensaje) es requerido'
            ]);
            ...
            $twilioWhatsApp = 'whatsapp:+14155238886'; // Sandbox de Twilio
