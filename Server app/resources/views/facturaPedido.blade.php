...
<html lang="en" dir="ltr">
  ...
  <body>
    <p class="text-spacing-3 header-title text-center text-uppercase">
        {{$pedido['envs']->stgg_header->value}}
    </p>
    <p class="text-spacing-3 header-title text-center text-uppercase">recibo</p>
    <hr class="hr-style-mb mt-2-5">
    <div>
      <p class="text-uppercase">
        CASA MATRIZ: {{$pedido['envs']->stgg_casa_matriz->value}}
      </p>
      <p class="text-uppercase">
        CONTACTO: {{$pedido['envs']->stgg_contacto->value}}
      </p>
      <p class="text-uppercase">
        HORARIO: {{$pedido['envs']->stgg_horario->value}}
      </p>
      <p class="text-uppercase">
        {{$pedido['envs']->stgg_url->value}}
      </p>
    </div>
    <hr class="hr-style">
    <div>
      <p class="text-uppercase">Fecha: {{DateTime::createFromFormat("Y-m-d H:i:s",$pedido['created_at'])->format("d/m/Y")}}</p>
      <p class="text-uppercase">Hora:  {{DateTime::createFromFormat("Y-m-d H:i:s",$pedido['created_at'])->format("H:i:s")}}</p>
    </div>
    <hr class="hr-style">
