...
<body>
    <div class="container">
        ...
        <div class="terminal-info">
            <strong>🖥️ Terminal:</strong> NEWLAND_N950__N950NCC302980808<br>
            <strong>📍 Modo:</strong> PDV
        </div>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($monto < 100) {
                echo '<div class="alert alert-error">❌ El monto mínimo es $100 CLP</div>';
            } else {
                ...
                if ($httpCode === 201) {
                    ...
                    echo '✅ <strong>¡Pago enviado exitosamente!</strong><br><br>';
                    ...
                    echo '🖨️ El pago ya está en el Point Smart, esperando tarjeta...';
                    echo '</div>';
                } else if ($httpCode === 409) {
                    echo '<div class="alert alert-warning">';
                    echo '⚠️ <strong>Ya hay un pago pendiente en el terminal</strong><br><br>';
                    echo 'Cancelá o completá el pago actual antes de enviar uno nuevo.';
                    echo '</div>';
                } else {
                    echo '<div class="alert alert-error">';
                    echo '❌ <strong>Error al crear el pago</strong><br><br>';
        ...
        <form method="POST">
            <div class="form-group">
                <label for="monto">💰 Monto en CLP</label>
                <input 
                    type="number" 
                    id="monto" 
                    name="monto" 
        ...
        <div class="info-box">
            ...
            • El monto mínimo es $100 CLP<br>
            • No uses decimales (Ej: 1000, no 1000.00)<br>
            • El pago aparecerá inmediatamente en el Point Smart<br>
            • Solo se puede tener 1 pago pendiente a la vez
        </div>
    </div>
</body>
</html>
