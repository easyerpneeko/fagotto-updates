-- TABLA: TurnosCaja (Versión Compatible MySQL 5.7+)
...
CREATE TABLE TurnosCaja (
    ...
    diferencia_total DECIMAL(15,2) NOT NULL DEFAULT 0,
    
    -- DETALLE POR MÉTODO DE PAGO (TEXT como JSON)
    detalle_efectivo TEXT NOT NULL,
    detalle_medios_pago TEXT NOT NULL,
