-- ========================================
-- AGREGAR CAMPOS DE PAGO A TODAS LAS BASES DE DATOS LOCALES (31 BASES)
...
ADD COLUMN payment_status ENUM('pending', 'paid', 'failed') DEFAULT 'pending' AFTER status,
ADD COLUMN payment_id VARCHAR(255) AFTER payment_status,
ADD COLUMN payment_method VARCHAR(50) AFTER payment_id,
ADD COLUMN whatsapp VARCHAR(20) AFTER contact_phone;
