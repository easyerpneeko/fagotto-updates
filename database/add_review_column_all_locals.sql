-- ========================================
-- AGREGAR COLUMNA REVIEW A TODAS LAS BASES DE DATOS LOCALES
-- Ejecutar este script en el servidor MySQL posfagotto.cl
-- Función: Permitir comentarios/reseñas sobre pedidos desde pedidos.vue y pedidofinal.vue
-- ========================================

-- 1. Fagotto Agustinas
USE erd_app_faggotoo_agustina_65a757ec101ac;
ALTER TABLE requests ADD COLUMN review TEXT NULL COMMENT 'Comentarios o reseñas sobre el pedido' AFTER comment;
...
-- ========================================
-- VERIFICACIÓN: Verificar que se agregó correctamente
-- ========================================
-- SELECT TABLE_SCHEMA, TABLE_NAME, COLUMN_NAME, COLUMN_TYPE 
-- FROM information_schema.COLUMNS 
-- WHERE COLUMN_NAME = 'review' 
-- AND TABLE_NAME = 'requests'
-- AND TABLE_SCHEMA LIKE 'erd_app_%'
-- ORDER BY TABLE_SCHEMA;

-- ========================================
-- ✅ MIGRACIÓN COMPLETADA
-- Total de bases de datos actualizadas: 31
-- Columna agregada: review (TEXT NULL)
-- ========================================
