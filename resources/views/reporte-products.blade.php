...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <p class="text-spacing-3 header-subtitle text-center text-uppercase">Reporte de Ventas con Estadísticas</p>
    ...
    <table>
      ...
      <?php } ?>
      <!-- 10. Halloween 20% -->
      <?php if(isset($data['counters']['halloween_20'])) { ?>
        <tr>
          <td>🎃 Halloween 20%</td>
          <td>${{ formatoChilenoReporte($data['counters']['halloween_20']) }}</td>
        </tr>
      <?php } ?>
      <!-- 11. Uber Eats -->
