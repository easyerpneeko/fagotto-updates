...
Route::group(['middleware' => ['JwtMiddleware']], function () {
  ...
  Route::post('/discount', 'Controllers_local\ProductDiscountController@store');
  Route::put('/discount/{id}', 'Controllers_local\ProductDiscountController@update');
  Route::delete('/discount/{id}', 'Controllers_local\ProductDiscountController@destroy');
  Route::put('/discount/{id}/toggle', 'Controllers_local\ProductDiscountController@toggle');
  Route::post('/discount/{id}/clone', 'Controllers_local\ProductDiscountController@cloneToMultipleBranches');
  Route::get('/discount/branches', 'Controllers_local\ProductDiscountController@getBranches');
  
  // APIs para el POS - Consultar descuentos activos
  Route::get('/discount/branch/{applicationId}', 'Controllers_local\ProductDiscountController@getActiveDiscountsByBranch');
  Route::post('/discount/check', 'Controllers_local\ProductDiscountController@checkProductDiscount');
