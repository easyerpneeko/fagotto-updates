    ...
    return {
      ...
      jsonTable: {
        ...
        rows: [
          ...
          { key: 'product', class: '', permission: 'default' },
          { key: 'priceProductDevolution', class: '', permission: 'default' },
        ...
        titles: [
          { label: '#', class: 'th-xs text-center d-none-1', permission: 'default', type: false },
