 ...
 <div class="product-bg d-flex flex-column px-3">
    ...
    <div class="col-8 Jfondo-1">
      ...
      <!--==========================================================================================================================-->
          ...
          <div class="col-12 p-0 space-between-search-and-create">
            ...
            <div class="input-group input-group-sm mb-3 autocomplete-input-container">
              <autocomplete :search="search" class="form-control" placeholder="Buscar" :getResultValue="getSearchValue" @submit="submitAutocomplete" ref="productAutocomplete" ></autocomplete>
            ...
            <div class="btns_sell">
              ...
              <button type="button" class="m-1 btn bg-secundario text-white text-capitalize" @click="crearGuiaDespacho()">
                Guia de Despacho
              </button>
        ...
        <!--==========================================================================================================================-->
          ...
          <div class="col-12 scroll-h  fondo-table">
            <hr>
            <table class="m-0 table table-striped table-bordered table-sm">
            ...
            <div class="row">
              ...
              <div class="col-12">
                <h4>¡Te deseamos lo mejor en este día! Es hora de usar EasyERP</h4>
              </div>
            </div>
  ...
  <div class="product-bg d-flex flex-column px-3">
    ...
    <div class="row">
      <div class="col-12 p-0 space-between-search-and-create">
        ...
        <div class="btns_sell">
          <button class="btn btn success ">prueva</button>
          <button @click="newTicket()" type="button" v-if="(ticketInstaller && tickets)" :disabled="editOrder" class="m-1 btn bg-primario text-white text-capitalize">
            Crear ticket
          </button>
          <button type="button" class="m-1 btn bg-secundario text-white text-capitalize" @click="crearGuiaDespacho()">
  ...
  <!--==========================================================================================================================-->
    ...
    <div class="row pt-1 h-87">
      <div class="col-md-6-5 scroll-h  fondo-table">
