            ...
            <div class="pl-2 d-flex row w-100">
                <div class="card title-card col-md-5 col-sm-7 col-12">
                    <div class="card-body">
                        ...
                        <span>Realizar pedidos de reposteria</span>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="item-content colBottomMargin">
                                        <div class="item-info">
                                            <h2 class="item-title">Nuevo pedido de reposteria</h2>
                                            ...
                                            <div class="form-group row d-flex justify-content-between col-sm-12">
                                                ...
                                                <div>
                                                    <button type="button" data-toggle="modal"
                                                        data-target="#pedidoModal" @click="openCatalog"
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            <tr v-for="(producto, id) in jsonTableProducts.items" :key="id">
                                                ...
                                                <td>${{ formatearMonto(producto.quantity * producto.price)}}</td>
                                            </tr>
                                        </tbody>
                                    </table>
...
import catalog from '@/components/modals/reposteria/catalog.vue';
...
export default {
    ...
    methods: {
        ...
        async getRequests(page = false) {
            ...
            var request = await this.$store.dispatch("requests/getRequestsReposteria", params);
        ...
        async newRequest() {
            ...
            if (this.products.length > 0) {
                ...
                this.waitResponse = true;
                Loader.fullPage();
                let request = await this.$store.dispatch('requests/newRequestReposteria', formData);
                Loader.hide();
        ...
        async sendReview() {
            ...
            if (this.review.length > 0) {
                ...
                if (this.review != null) var request = await this.$store.dispatch("requests/reviewReposteria", { id: this.idRequest, data });
