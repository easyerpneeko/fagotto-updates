<?php
/**
 * CAMBIAR TERMINAL A MODO STANDALONE
 * Útil para resetear el terminal y sacarlo del modo PDV
 */
...
echo "🔄 CAMBIAR TERMINAL A MODO STANDALONE\n";
echo str_repeat("═", 70) . "\n\n";
echo "🖥️  Terminal: $deviceId\n\n";

// Cambiar a STANDALONE
echo "📡 Cambiando a modo STANDALONE...\n";
...
if ($httpCode == 200 || $httpCode == 201) {
    echo "✅ ¡Terminal cambiado a STANDALONE exitosamente!\n\n";
    ...
    echo "   Reinicia el terminal físicamente para forzar la sincronización\n\n";
} else {
